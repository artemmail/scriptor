...
BROKER_NAME = os.getenv("EVENTBUS_BROKER", "workspace_development2")
...
COMMAND_QUEUE = os.getenv("EVENTBUS_COMMAND_QUEUE_NAME", "w.ds_development_cmd1")
RESPONSE_QUEUE = os.getenv("EVENTBUS_QUEUE_NAME", "w.ds_devel2")
