...
export class AboutBusinessComponent {
  ...
  readonly features: Feature[] = [
    {
      ...
      description:
        'YouScriptor превращает встречи из Zoom, Meet или офлайн в точные текстовые протоколы с распределением по спикерам и тайм-кодами.',
    },
    {
  ...
  readonly steps: Step[] = [
    {
      title: 'Подключите YouScriptor к вашим источникам',
      description:
  ...
  readonly caseStudies: CaseStudy[] = [
    {
      ...
      details:
        'Вся продуктовая переписка и заседания фиксируются в YouScriptor. Руководители получают отчёт утром после встречи и сразу вносят корректировки.',
    },
    {
  ...
  readonly faqs: FAQItem[] = [
    {
      ...
      answer:
        'Да. YouScriptor поддерживает вебхуки, REST API, а также интеграции с Slack, Telegram, Bitrix24 и корпоративной почтой.',
    },
    {
