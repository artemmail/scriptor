...
export class YoutubeDownloaderComponent implements OnInit, OnDestroy {
  readonly heroHighlights = [
    'Отдельно звуковая дорожка с конвертацией в mp3',
    'Видео с несколькими аудио дорожками в контейнере mp4',
    'Видео без аудиодорожек'
  ];

  readonly cardHighlights = [
    {
      title: 'Без рекламы и ожидания',
      description: 'Поставил на скачивание - вернулся за файлом через время.'
    },
    {
      title: 'Выбор дорожек',
      description: 'Выбирайте из реально доступных дорожек - выбирайте сами качество и размер.'
    },
    {
      title: 'Аудио/видео или несколько дорожек',
      description: 'Для мультиязычных роликов можно выбрать несколько аудиодорожек.'
    }
  ];
