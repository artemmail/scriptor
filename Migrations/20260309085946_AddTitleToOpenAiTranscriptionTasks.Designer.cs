...
namespace YandexSpeech.Migrations
{
    ...
    [Migration("20260309085946_AddTitleToOpenAiTranscriptionTasks")]
    partial class AddTitleToOpenAiTranscriptionTasks
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("YandexSpeech.models.DB.OpenAiTranscriptionTask", b =>
                {
                    ...
                    b.Property<DateTime?>("QuotaChargedAt")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<int>("RequestedTranscriptionMinutes")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("SourceDurationSeconds")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("YandexSpeech.models.DB.SubscriptionPlan", b =>
                {
                    ...
                    b.Property<int>("IncludedTranscriptionMinutes")
                        .HasColumnType("int");

                    b.Property<int>("IncludedVideos")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("YandexSpeech.models.DB.UserSubscription", b =>
                {
                    ...
                    b.Property<int>("GrantedTranscriptionMinutes")
                        .HasColumnType("int");

                    b.Property<int>("GrantedVideos")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("RemainingTranscriptionMinutes")
                        .HasColumnType("int");

                    b.Property<int>("RemainingVideos")
                        .HasColumnType("int");
