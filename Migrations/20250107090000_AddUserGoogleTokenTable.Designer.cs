...
namespace YandexSpeech.Migrations
{
    ...
    [Migration("20250107090000_AddUserGoogleTokenTable")]
    partial class AddUserGoogleTokenTable
    {
        /// <inheritdoc />
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("YandexSpeech.models.DB.UserGoogleToken", b =>
                {
                    b.Property<string>("UserId")
                        .HasMaxLength(450)
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<DateTime?>("AccessTokenUpdatedAt")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("YandexSpeech.models.DB.UserGoogleToken", b =>
                {
                    b.HasOne("YandexSpeech.models.DB.ApplicationUser", "User")
                        .WithOne("GoogleToken")
                        .HasForeignKey("YandexSpeech.models.DB.UserGoogleToken", "UserId")
