...
BEGIN
    INSERT INTO RecognitionProfiles (Name, DisplayedName, Hint, Request, ClarificationTemplate, OpenAiModel, SegmentBlockSize)
    VALUES (
        'integrated-formatting',
        N'Форматирование и пунктуация',
        N'Используйте для диалогов, где нужен готовый Markdown-скрипт с чёткими спикерами.',
...
BEGIN
    ...
    VALUES (
        ...
        N'Применяйте, когда нужно быстро навести порядок без глубокого анализа содержимого.',
